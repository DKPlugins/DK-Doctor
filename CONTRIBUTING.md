...
dk-doctor is open source under the **MIT License** — see [LICENSE](LICENSE). By submitting a
contribution you agree that it is licensed to the project under the same MIT terms.
